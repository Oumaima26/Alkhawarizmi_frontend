    ...
    <Box sx={{ flexGrow: 1 }} >
      <AppBar position="static" style={{ height: "50px" }}>
        <Toolbar>
          ...
          <Button color="inherit">
            <Link href="/signin" color="inherit" underline="none"><i className="fas fa-sign-in-alt" ></i> SignIn</Link>
          </Button>
          <Button color="inherit">
            <Link href="/signup" color="inherit" underline="none"><i className="fa fa-user-plus" ></i> Sign Up</Link>
          </Button>
        </Toolbar>
      </AppBar>
    </Box>
