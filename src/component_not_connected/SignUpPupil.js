...
export default function SignUpPupil() {
    ...
    const handleSubmit = (event) => {
        ...
        axios.post('http://localhost:5000/pupil/register', {
            ...
            first_name_father: data.get('firstName'),
            last_name_father: data.get('lastName'),
            first_name_mother: data.get('firstName'),
            last_name_mother: data.get('lastName'),
            photo: previewImage,
            ...
            .then(res => {
                if(res){
                    //nextPath('/pupil/signin')
                }
            })
            .catch(err => {
                if(err){
                    //nextPath('/pupil/signup')
                }
            });
    };
    return (
                    ...
                    <Paper variant="outlined" sx={{ my: { xs: 3, md: 6 }, p: { xs: 2, md: 3 } }}>
                        ...
                        <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 3 }}>
                            ...
                            <Grid container spacing={2}>
                                ...
                                <FormControl variant="standard" sx={{ m: 2, minWidth: 230 }} xs={12} sm={6}>
                            ...
                            <Grid container justifyContent="flex-end">
                                <Grid item>
                                    <Link href="/pupil/signin" variant="body2">
